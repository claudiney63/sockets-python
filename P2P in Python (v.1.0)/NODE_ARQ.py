...
class Node:
    def __init__(self, node_ip):
        ...
        self.arqui_recebido = "recebido_p1.txt"
    ...
    def central_comandos(self):
        while True:
            ...
            # if escolha == 1:
            #     escrever = str(input("Digite o que deseja escrever: "))
            #     with open(self.nome_arqui, "w", "utf-8") as arquivo:
            ...
            if escolha == 2:
                nome_arqui = input("Nome arquivo: ")
                self.cliente.send(f"BUSCA_ARQUIVO//P{self.id}//{nome_arqui}".encode("utf-8"))
